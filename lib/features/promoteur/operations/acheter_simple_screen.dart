...
class AcheterSimpleScreen extends StatefulWidget {
  final ClientModel client;
  const AcheterSimpleScreen({super.key, required this.client});
  @override
  State<AcheterSimpleScreen> createState() => _AcheterSimpleScreenState();
}

class _AcheterSimpleScreenState extends State<AcheterSimpleScreen> {
